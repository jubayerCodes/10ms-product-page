...
import { Instructor, Section } from '@/types/types';
import React from 'react';

const Instructors = ({ instructors, section }: { instructors: Instructor[], section: Section }) => {
